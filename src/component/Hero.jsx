...
export const Hero = () =>{
  return(
    <section id='home ' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <h1 className='font-poppins font-semibold ss:text-[65px]
       text-[50px] text-white ss:leading-[100px]
        leading-[75px] w-full'>Payment Method
       </h1>
       <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methology
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className='absolute  z-[0] w-[50%] h-[50%] bottom-80 white__gradient'/>
   
          <div className='absolute  z-[0] w-[40%] h-[50%] right-10 bottom-20 blue__gradient'/>
